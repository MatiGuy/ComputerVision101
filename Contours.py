...
#
# NOTE In OpenCV 3.X, findContours returns a 3rd argument which is ret
# (or a boolean indicating if the function was successfully run).
#
# If you're using OpenCV 3.X replace line 12 with:
#
# , contours, hierarchy = cv2.findContours(image, cv2.RETREXTERNAL, cv2.CHAIN_APPROX_NONE)
#
...
# Using cv2.CHAIN_APPROX_NONE stores all the boundary points. But we don't necessarily need all bounding points.
